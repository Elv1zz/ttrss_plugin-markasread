...
class MarkAsRead extends Plugin {
	...
	function hook_article_button($line) {
		...
		return "<span style='cursor: pointer; vertical-align: bottom;' onclick='markasreadClicked(event,$myId);'><span style='min-width: 15px; min-height: 15px;' class='markasread'><img src='" . basename(dirname(__FILE__, 2)) . "/markasread/trans.png' class='tagsPic' width='15' height='15' /></span>".__('Unread')."</span>";
	}
